...
<h1 style="margin-bottom:10px;text-align: center;">查询员工信息</h1>	
...
<table class="layui-table">
	...
	<c:if test="${not empty staffmsg}">
 <span style="color:  red">${staffmsg}</span>
</c:if>
...
<div  class="layui-form-item"style="">
			    <div  id="lab1" class="layui-input-block" style="float: right;margin-right: 135px;" >
			      <button  type="button" class="layui-btn layui-btn-normal" ><a href="${path}/staffShow" target="frame1">返回</a></button>
			    </div>
			  </div>
</fieldset>
