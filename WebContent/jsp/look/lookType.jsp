...
<h1 style="margin-bottom:10px;text-align: center;">查询商品类别信息</h1>	
...
<div  class="layui-form-item"style="border: red 1px solid;">
			    <div  id="lab1" class="layui-input-block" style="float: right;margin-right: 135px;" >
			      <button  type="button" class="layui-btn layui-btn-normal" ><a href="${path}/typeShow" target="frame1">返回</a></button>
			    </div>
			  </div>
</fieldset>
