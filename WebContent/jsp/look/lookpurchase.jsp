...
<h1 style="margin-bottom:10px;text-align: center;">查询订单信息</h1>	
...
<span style="color: red;">${purchasemsg}</span>
...
<div  class="layui-form-item" >
			   <div  id="lab1" class="layui-input-block" style="float: right;margin-right: 135px;" >
			     <!--  <button class="layui-btn" lay-submit lay-filter="formDemo" type="button" onclick="sub()">确定</button> -->
			      <button type="button" class="layui-btn layui-btn-normal"  ><a href="${path}/purchaseShow" >返回</a></button>
			    </div>
			  </div>
</fieldset>
