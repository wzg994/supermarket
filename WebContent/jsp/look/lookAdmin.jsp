...
<h1 style="margin-bottom:10px;text-align: center;">查询的管理员信息</h1>	
...
<table class="layui-table">
 ...
 <span style="color:  red">${adminmsg}</span>
</c:if>
...
<div  class="layui-form-item"style="">
			    <div  id="lab1" class="layui-input-block" style="float: right;margin-right: 135px;" >
			      <button  type="button" class="layui-btn layui-btn-normal" ><a href="${path}/adminShow" target="frame1">返回</a></button>
			    </div>
			  </div>
</fieldset>
	...
	//window.location.href="${path}/operationSupplier?operation=2&supplierId="+supplierId
 	layer.open({
	     ...
	     // skin: 'demo-class',
	      ...
	      content: "${path}/operationAdmin?operation=2&staffid="+staffid
	    });  
...
function del(staffid) {
	//alert("正在删除")
	window.location.href="${path}/operationAdmin?operation=4&staffid="+staffid;
}
...
function selectshop() {
	...
	if (supid=="") {
		...
		alert("查询")
		window.location.href="${path}/operationAdmin?operation=5&adminname="+supid;
	}
