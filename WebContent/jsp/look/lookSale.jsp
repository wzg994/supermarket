...
<h1 style="margin-bottom:10px;text-align: center;">查询销售信息</h1>	
...
<div  class="layui-form-item">
			    <div  id="lab1" class="layui-input-block" style="float: right;margin-right: 135px;" >
			      <button  type="button" class="layui-btn layui-btn-normal" ><a href="${path}/saleShow" target="frame1">返回</a></button>
			    </div>
			  </div>
