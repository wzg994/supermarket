...
<h1 style="margin-bottom:10px;text-align: center;">查询商品信息</h1>	
...
<span style="color: red;">${productmsg}</span>

</c:if>	

<div  class="layui-form-item">
			    <div  id="lab1" class="layui-input-block" style="float: right;margin-right: 135px;" >
			      <button  type="button" class="layui-btn layui-btn-normal" ><a href="${path}/productshow" target="frame1">返回</a></button>
			    </div>
			  </div>
</fieldset>
