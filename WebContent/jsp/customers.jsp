...
<c:if test="${not empty msg}">
 <span style="color:  red;margin: 0 auto;">${msg}</span>
	...
	<h2 style="margin-bottom:10px;text-align: center;">客户信息列表 </h2>
...
<form class="layui-form" action="${path}/addCustomer" id="form1" hidden="hidden" style="margin-top: 20px;text-align:center">
			  <div id="divf" class="layui-form-item">
			    ...
			    <div class="layui-input-inline">
			      <input id="cusid1"  type="text" name="cusid" required  lay-verify="required" placeholder="请输入客户ID" autocomplete="on" class="layui-input">
			    </div>
			  </div>
			  <div id="divf" class="layui-form-item">
			    <label id="lab1" class="layui-form-label">客户名字</label>
			    <div class="layui-input-inline">
			      <input id="cusname" value="${supplier.supname}" name="cusname" type="text" name="password" required lay-verify="required" placeholder="请输入客户名字" autocomplete="off" class="layui-input">
			    </div>
			  </div>
			  <div id="divf" class="layui-form-item">
			    <label id="lab1" class="layui-form-label">客户电话</label>
			    <div class="layui-input-inline">
			      <input id="custel" type="text" value="${supplier.suptel}" name="custel" required lay-verify="required" placeholder="请输入客户电话" autocomplete="off" class="layui-input">
			    </div>
			  </div>
			   <div id="divf" class="layui-form-item">
			    <label id="lab1" class="layui-form-label">负责人</label>
			    <div class="layui-input-inline">
			      <input id="person" type="text" value="" name="person" required lay-verify="required" placeholder="请输入负责人" autocomplete="off" class="layui-input">
			    </div>
			  </div>
			  <div id="divf" class="layui-form-item">
			    <label id="lab1" class="layui-form-label">客户地址</label>
			    <div class="layui-input-inline">
			      <input id="address" type="text" value="" name="address" required lay-verify="required" placeholder="请输入客户地址" autocomplete="off" class="layui-input">
			    </div>
			  </div>
