...
<body>
	<form class="layui-form" id="form2"
		...
		<div id="divf" class="layui-form-item"
			...
			<label id="lab1" class="layui-form-label">*商品类别ID</label>
			<div class="layui-input-inline">
				<input value="${staff.staffid}" type="text" name="typeid" required
					lay-verify="required" placeholder="请输入商品类别ID" autocomplete="on"
					class="layui-input">
			</div>
		</div>
		<div id="divf" class="layui-form-item" style="width: 400px">
			<label id="lab1" class="layui-form-label">*商品类别名称</label>
			<div class="layui-input-inline">
